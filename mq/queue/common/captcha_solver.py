...
from mq.mq_queue.common import CaptchaBadDuplicatesError, CaptchaUnsolvableError, \
    RuCaptchaZeroBalance, CaptchaNoSlotAvailable
from mq.mq_queue.common.infinite_gen import ExactlyChangedInfiniteGenerator, SuspendingInfiniteGenerator
